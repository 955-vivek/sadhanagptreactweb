...
const MenteeConversation = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0F172A] pb-28 font-sans transition-colors duration-300">
      <div className="bg-white dark:bg-[#1E293B] border-b border-gray-300 dark:border-[#334155] sticky top-0 z-10 px-6 py-6 flex items-center justify-between transition-colors duration-300">
      ...
      <div className="max-w-md mx-auto px-6 py-8">
        ...
        {/* Header Info */}
        <div className="bg-white dark:bg-[#1E293B] p-6 rounded-3xl shadow-sm border border-gray-400/70 dark:border-[#334155] mb-6 flex items-center gap-4 transition-colors duration-300">
        ...
        <div className="space-y-6 mb-10">
          ...
          <input 
            ...
            className="w-full bg-white dark:bg-[#1E293B] p-4 rounded-2xl border border-gray-300 dark:border-[#334155] focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/10 outline-none font-bold text-gray-800 dark:text-[#F8FAFC] [color-scheme:light] dark:[color-scheme:dark] transition-all"
          />
          ...
          <div>
            ...
            <div className="bg-white dark:bg-[#1E293B] rounded-2xl border border-gray-400/70 dark:border-[#334155] focus-within:border-indigo-500 dark:focus-within:border-indigo-400 focus-within:ring-4 focus-within:ring-indigo-500/10 transition-all overflow-hidden flex flex-col">
              
              {/* Toolbar */}
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 dark:bg-[#334155] border-b border-gray-300 dark:border-[#475569] transition-colors">
        ...
        <div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-10 bg-white dark:bg-[#1E293B] rounded-3xl border border-dashed border-gray-400/70 dark:border-[#334155] transition-colors duration-300">
              <p className="text-gray-400 dark:text-[#94A3B8] font-bold text-sm">No logs found.</p>
            </div>
          ) : (
            <div className="space-y-4">
              {notesList.map((note) => (
                <div key={note.id || note.note_id} className="bg-white dark:bg-[#1E293B] p-5 rounded-3xl shadow-sm border border-gray-400/70 dark:border-[#334155] group transition-colors duration-300">
